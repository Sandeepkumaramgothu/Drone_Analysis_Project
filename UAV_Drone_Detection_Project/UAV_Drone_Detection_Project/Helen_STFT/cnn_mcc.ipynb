...
Original file is located at
    https://colab.research.google.com/drive/1tKqQHb9W7k96vzSQM-aJuRaXV6ZCfGzi
"""
...
model.save('al-emadi_cnn_mcc_standardized_unknown.keras')
...
model = tf.keras.models.load_model('al-emadi_cnn_mcc_standardized_unknown.keras')
...
#RAVI COMMENT: Unknown drone detection method code here. Copy and paste this into your file and follow any further instructions indicated by comments
...
model = tf.keras.models.load_model('/content/al-emadi_cnn_mcc_standardized_unknown (1).keras')
...
spectrogram_dir = '/content/drive/MyDrive/Summer REU/New STFT/Test/Phantom'

entropy_threshold = 0.0000006
